  ...
  chooseWallet = () => {
    ...
    .then(response => {
      if(response.status != 200) {
        ...
        tronApi.sendToken(toAddress, initialTokens, this.props.userid, false)
        .then(res => {
          this.setState({transfering: false})
          this.props.close()
          Alert.alert('Successful', 'Tokens has been transferred to your wallet successfully.')
        }, err => {
          this.setState({transfering: false})
                ...
                <View style={{padding: 10}}>
                  ...
                  <View>
                    ...
                    <TouchableOpacity style={styles.subscribe_btn} onPress={this.goToWallet}>
                      <Text style={styles.btn_text}>Change wallet address</Text>
                    </TouchableOpacity>
                  </View>
                     :
